...
def paper(id, timeout=2, include_unknown_references=False, headers=None) -> dict:
    ...
    data = __get_data('paper', id, timeout, include_unknown_references, headers)
...
def __get_data(method, id, timeout, include_unknown_references=False, headers=None) -> dict:
